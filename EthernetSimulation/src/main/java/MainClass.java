...
public class MainClass {
    ...
    private void runAntennas() {
        ...
        for (int i = 0; i < TRANSMITTING_ANTENNAS; i++) {
            ...
            antenna[i] = new Thread(() -> {
                int positionOfTransmission = 23 * idAntenna;
    ...
    private synchronized boolean startTransmit(int leftPropagation, int rightPropagation, int idAntena) {
    ...
    private void printStatusOfConnection() {
        for (int i = 0; i < ETHERNET_LENGTH; i++) System.out.print(ethernetWire[i] + "|");
